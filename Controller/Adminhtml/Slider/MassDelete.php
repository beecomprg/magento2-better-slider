...
class MassDelete extends \Magento\Backend\App\Action
{
     ...
     * @param \Beecom\BetterSlider\Model\ResourceModel\Slider\CollectionFactory $collectionFactory
     * @param \Magento\Backend\App\Action\Context $context
     */
    public function __construct(
        \Magento\Ui\Component\MassAction\Filter $filter,
        \Beecom\BetterSlider\Model\ResourceModel\Slider\CollectionFactory $collectionFactory,
    ...
    public function execute()
    {
        ...
        foreach ($collection as $item) {
            /** @var \Beecom\BetterSlider\Model\Slider $item */
            $item->delete();
            $delete++;
        }

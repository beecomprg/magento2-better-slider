...
class Banner extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var \Beecom\BetterSlider\Model\ResourceModel\Banner\Collection $collection */
    ...
    /**
     * @param \Beecom\BetterSlider\Model\Banner|\Magento\Framework\Object $item
     * @return string
     */
    ...
    {
        return $this->coreRegistry->registry('beecom_betterslider_slider');
    }
    ...
    {
        return $this->getUrl('beecom_betterslider/slider/banners', ['_current' => true]);
    }

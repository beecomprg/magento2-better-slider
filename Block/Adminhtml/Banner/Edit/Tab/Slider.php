...
class Slider extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var \Beecom\BetterSlider\Model\ResourceModel\Slider\Collection $collection */
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('beecom_betterslider_banner_slider')],
    ...
    /**
     * @param \Beecom\BetterSlider\Model\Slider|\Magento\Framework\Object $item
     * @return string
     */
    ...
    /**
     * @return \Beecom\BetterSlider\Model\Banner
     */
    public function getBanner()
    {
        return $this->coreRegistry->registry('beecom_betterslider_banner');
    }
    ...
    {
        return $this->getUrl('beecom_betterslider/banner/sliders', ['_current' => true]);
    }

 ...
 */
namespace Beecom\BetterSlider\Model\ResourceModel;
...
class Banner extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function __construct(
        ...
        $this->bannerSliderTable = $this->getTable('beecom_betterslider_banner_slider');
    }
    ...
    {
        $this->_init('beecom_betterslider_banner', 'banner_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Beecom\BetterSlider\Model\Banner $object
     * @return $this
     */
    ...
    /**
     * @param \Beecom\BetterSlider\Model\Banner $banner
     * @return array
     */
    public function getSlidersPosition(\Beecom\BetterSlider\Model\Banner $banner)
    {
     ...
     * @return $this
     */
    protected function saveSliderRelation(\Beecom\BetterSlider\Model\Banner $banner)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'beecom_betterslider_banner_change_sliders',

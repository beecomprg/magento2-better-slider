...
class Slider extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function __construct(
        ...
        $this->sliderBannerTable = $this->getTable('beecom_betterslider_banner_slider');
    }
    ...
    {
        $this->_init('beecom_betterslider_slider', 'slider_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Beecom\BetterSlider\Model\Slider $object
     * @return $this
     */
     ...
     * @return array
     */
    public function getBannersPosition(\Beecom\BetterSlider\Model\Slider $slider)
    {
     ...
     * @return $this
     */
    protected function saveBannerRelation(\Beecom\BetterSlider\Model\Slider $slider)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'beecom_betterslider_slider_change_banners',
